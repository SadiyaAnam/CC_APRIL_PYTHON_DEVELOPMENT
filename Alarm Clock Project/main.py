...
root = Tk()
root.title('Sadiyas Alarm-Clock')
    ...
    while True:
        ...
        if time_now == alarmtime:
            Wakeup = Label(root, font=('arial', 20, 'bold'),
                           text="Wake up!Wake up!Wake up", bg="White", fg="Red").grid(row=6, columnspan=3)
            print("WAKE UP !")
            mixer.init()
            mixer.music.load(r'C:\Users\USER\PycharmProjects\pythonProject5\alarm-clock-short-6402.mp3')
            mixer.music.play()
            break
